...
import { updateMenuVeg , addMenuReview, createMenuItem, deleteMenuItem, getMenuById, getMenuItem, getMenuReviews, updateMenuItem } from "../controllers/menu.controllers.js"
...
router.route("/:resid/menu/:itemid").patch(verifyJWT, authRole, updateMenuItem)
router.route("/:resid/menu/:itemid").patch(verifyJWT, authRole, updateMenuVeg)
