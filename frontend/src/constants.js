// constants.js
// export const BASE_URL = 'https://scan-dine-backend-j9ci.onrender.com' || 'http://localhost:8080';
export const BASE_URL = 'https://scan-dine-backend-j9ci.onrender.com'  // = 'http://52.66.114.28' 
